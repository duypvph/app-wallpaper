...
const styles = StyleSheet.create({
    ...
    outlineButton: {
        ...
        borderRadius: theme.radius.xs, // Đã thay đổi từ borderCurve
    },
    outlineButtonText: {
        fontSize: hp(2),
    },
    color: {
        height: 30,
        width: 40,
        borderRadius: theme.radius.sm - 3, // Đã thay đổi từ borderCurve
    },
    colorWrapper: {
        padding: 3,
        borderRadius: theme.radius.sm, // Đã thay đổi từ borderCurve
        borderWidth: 2,
    }
});
